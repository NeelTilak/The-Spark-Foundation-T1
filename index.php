...
<html lang="en">
  ...
  <body style="background-image: linear-gradient(62deg, #A7AEE1 0%, #E0C3FC 100%);">
  <?php
  include 'navbar.php';
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-image: linear-gradient(62deg, #A7AEE1 0%, #E0C3FC 100%);" >
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                <br><br><br><br><br><br><br><br><br><br><br>
                  <h3 style="color:rgba(233,0,120,1)">Welcome to</h3>
                  <h1 style="color:rgba(233,0,120,1)">SPARK FOUNDATION BANK</h1>
                  <br><br><br>
                </div>
              </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:400px;" src="img\bank.png" alt="TSP Bank">
        </div>
        <div class="col-md-6 mx-auto mt-4">
          <div>
            <span class="text" style="color:black">SPARK FOUNDATION BANK</span>
          </div>
          <div class="mt-2">
            <span class="sub-content">Spark Foundation Banking System use for basic bank operation like transfer money and view the transaction. Also it provide create cutomer feature.</span>
          </div>
  ...
  <!-- End Contact -->
      ...
      <b>Spark Foundation</b> <p>&copy All Rights Reserved
      </footer>
